...
class handDetector():
    def __init__(self, mode=False, maxHands=2, detectionCon=False, trackCon=0.5):
        """
        This function initializes the handDetector class with parameters for hand detection.

        Args:
            mode (bool, optional): Static mode for single image or video mode for webcam. Defaults to False.
            maxHands (int, optional): Maximum number of hands to detect. Defaults to 2.
            detectionCon (float, optional): Minimum confidence value for hand detection. Defaults to False.
            trackCon (float, optional): Minimum confidence value for hand tracking. Defaults to 0.5.
        """
        self.mode = mode
        ...
        self.mpHands = mp.solutions.hands  # Create a Hands object from MediaPipe solutions
